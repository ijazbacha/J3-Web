...
import serviceBanner from 'assets/serviceBanner.svg';
  ...
  return (
    <section sx={{ variant: 'section.services' }}>
      <Container sx={styles.containerBox}>
        {/* <Box> */}
          <Image src={serviceBanner} sx={styles.thumbnail} alt="Thumbnail" />
          {/* <Button
            sx={styles.videoBtn}
            onClick={handleClick}
        ...
        <Box sx={styles.contentBox}>
          ...
          <Grid sx={styles.grid}>
            {data.features.map((e) => (
              <Box sx={styles.card} key={e.id}>
                {/* <Image src={e.imgSrc} alt={e.altText} sx={styles.icon} /> */}
